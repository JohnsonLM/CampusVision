...
Next, update the configuration at path `/instance/config.py` based omn your needs. Please note that you *must* change the lines noted in the comments for the software to run.
